...
buttons.with_icon = function(args)
    ...
    local icon_size = args.icon_size or 10
    local icon_margin = args.icon_margin or 1
    ...
    elseif shape == 'rounded_rect' then
        result:set_shape(function(cr, width, height) gears.shape.rounded_rect(cr, width, height, 2) end)
    else
